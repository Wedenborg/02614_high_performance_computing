...
__global__
void jacobi_serial(int N, double ***u, double ***v, double ***f, int iter_max, double tolerance)
{
    jacobi(int N, double ***u, double ***v, double ***f, int iter_max, double tolerance);
} 
